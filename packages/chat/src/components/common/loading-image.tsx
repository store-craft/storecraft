...
export const RegularLoader = () => 
  <div className='w-full h-full bg-slate-500/40 animate-pulse rounded-md'/>;
      ...
      <div className='w-full h-full relative cursor-pointer' >
        ...
        </div>
        {
          ...
          <>
            ...
            <div 
              className={'w-full h-full absolute inset-0 ' + ' duration-500 transition-all ' + (ready ? 'opacity-100' : 'opacity-0')}>
              <img 
                src={source} {...rest} 
                onLoad={onLoad}
...
export const LoadingSingleImage = (
  ...
  useEffect(
    () => {
      sdk.storage.getSource(src, true).then(onLoad);
    }, [src, onLoad]
  );
  ...
  return (
    <div {...rest}>
      <div 
        ...
        <img 
          src={source} 
          className={'absolute w-full h-full left-0 top-0 my-0 \
            rounded-md object-cover transition-all duration-1000 --p-2 ' + (
