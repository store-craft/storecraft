...
export type claude_message_text_content = {
  text: string
  type: 'text'
}

export type claude_message_tool_use_content = {
  id: string
  input: object
  name: string
  type: 'tool_use'
...
export type claude_message_tool_result_content = {
  tool_use_id: string
  type: 'tool_result'
  is_error?: boolean
  content: string | claude_message_text_content | claude_message_image_content
}


export type claude_message_image_content = {
  source: {
    data: string;
...
export type claude_message = {
  content: string | (
    (
      claude_message_text_content | 
      claude_message_image_content | 
      claude_message_tool_use_content | 
      claude_message_tool_result_content
    ) & with_cache_control)[];
  role: 'user' | 'assistant'
}
...
export type claude_completion_response = {
  ...
  content: (claude_message_text_content | claude_message_tool_use_content)[];
...
export type stream_event_content_block_start = {
  ...
  index: number,
  content_block: claude_message_text_content | claude_message_tool_use_content
}
