export type roles = 'user' | 'tool' | 'assistant' | 'system' | 'developer';
...
export type assistant_message_content_text = {
  type: 'text';
  /** The text content. */
  text: string;
} 

export type assistant_message_content_refusal = {
...
export type assistant_message = {
  ...
  content?: string | (
    assistant_message_content_text | 
    assistant_message_content_refusal
  )[];
...
export type chat_message = 
  developer_message | system_message | user_message | 
