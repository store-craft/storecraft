...
type InferLastSlug<T extends string> = 
...
type cc = string
export type ResourcesPostfixMap = {
  ...
  'chats': App["db"]["resources"]['chats']["$type_get"],
  'extensions': ExtensionItemGet,
  'gateways': PaymentGatewayItemGet,
}

export type InferResourceType<
  T extends string = keyof ResourcesPostfixMap,
> = ResourcesPostfixMap[InferLastSlug<T> & keyof ResourcesPostfixMap]


type collections_resources = | 
  "collections" | "products" | "tags" | "customers" | 
  "storefronts" | "images" | "posts" | "templates" | 
  "notifications" | "discounts" | "orders" | "shipping" | 
  "auth/users" | "chats";

type extra_non_collections_resources = 'payments/gateways' | 'extensions';
