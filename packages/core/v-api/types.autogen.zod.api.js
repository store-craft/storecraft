...
export const filterMetaEnumSchema = z.object({
  p_in_collections: z.object({
    ...
    name: z.literal("Product In Collection").optional(),
  }),
  p_not_in_collections: z.object({
    id: z.literal(1),
    type: z.literal("product"),
    op: z.literal("p-not-in-collections"),
    name: z.literal("Product not in Collection").optional(),
  }),
  ...
  p_in_tags: z.object({
    ...
    name: z.literal("Product has Tag").optional(),
  }),
  p_not_in_tags: z.object({
    id: z.literal(5),
    type: z.literal("product"),
    op: z.literal("p-not-in-tags"),
    name: z.literal("Product excludes Tag").optional(),
  }),
  p_all: z.object({
    id: z.literal(6),
    type: z.literal("product"),
    op: z.literal("p-all"),
    name: z.literal("All Products").optional(),
  }),
  p_in_price_range: z.object({
    id: z.literal(7),
    type: z.literal("product"),
    op: z.literal("p-in-price-range"),
    name: z.literal("Product in Price range").optional(),
  }),
  o_subtotal_in_range: z.object({
    id: z.literal(100),
    type: z.literal("order"),
    op: z.literal("o-subtotal-in-range"),
    name: z.literal("Order subtotal in range").optional(),
  }),
  o_items_count_in_range: z.object({
    id: z.literal(101),
    type: z.literal("order"),
    op: z.literal("o-items-count-in-range"),
    name: z.literal("Order items count in range").optional(),
  }),
  o_date_in_range: z.object({
    id: z.literal(102),
    type: z.literal("order"),
    op: z.literal("o-date-in-range"),
    name: z.literal("Order in dates").optional(),
  }),
  o_has_customer: z.object({
    id: z.literal(103),
    type: z.literal("order"),
    op: z.literal("o-has-customer"),
    name: z.literal("Order has Customers").optional(),
  }),
});
