...
import { SettingsData } from './js-docs-types'
    
/**
 * 
 * @param {SettingsData} d 
...
export default class Settings {
   ...
   * @returns {Promise<[boolean, string, SettingsData]>}
   */
   ...
   * @param {string} id 
   * @param {SettingsData} data
   * @returns {Promise<[id: string, data: SettingsData]>}
   */
  set = async (id, data) => {
    try {
   ...
   * @returns {Promise<[string, SettingsData][]>>} a one promise or next handler iterator
   */
   ...
   * @param {boolean} iterator true will give you a next iterator function for pagination 
   * @returns {Promise<[string, SettingsData][]> | ()=>Promise<[string, SettingsData][]>} a one promise or next handler iterator
   */
