...
import { withCard } from '@/admin/comps/common-fields.jsx'
import ErrorMessage from '@/admin/comps/error-message.jsx'
import JsonView from '@/admin/comps/json.jsx'
import { Div, HR } from '@/admin/comps/common-ui.jsx'
...
<div className='w-full lg:min-w-fit mx-auto'>
  ...
  <div className='flex flex-col --justify-between --h-full'>
    <span children='Payment Gateway' className='text-3xl text-black dark:text-gray-300' />
    <div className='flex flex-row items-center gap-2 h-20'>
      <Logo src={logo_url} className='w-8 h-8' />
      <span children={doc?.info?.name} className='text-3xl text-gray-500 tracking-wide' />
    </div>
  </div>
