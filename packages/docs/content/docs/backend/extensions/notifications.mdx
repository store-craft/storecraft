...
If you followed the previous [Overview](backend/extensions/overview), you have
seen a quick example and how easy it is to extend **Storecraft** with extensions.

Here, we review the interface
