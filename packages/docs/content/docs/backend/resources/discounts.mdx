...
This enum is called `DiscountMetaEnum` and is Found at `import { enums } from '@storecraft/core/v-api'`
...
This relevant enum is called `DiscountApplicationEnum` and is Found at `import { enums } from '@storecraft/core/v-api'`
...
Here is it's defintion, found at `import { enums } from '@storecraft/core/v-api'`, but also declared
at `import type { FilterMetaEnum } from '@storecraft/core/v-api'`
...
import type { DiscountUpsertType } from '@storecraft/core/v-api';
