...
<Image src={`/landing/main.webp`} className='w-full h-fit' 
       label={undefined}/>
...
**Dashboard** is located at `/api/dashboard`
...
You can find the code of the **Dashboard** at [Github](https://github.com/store-craft/storecraft/tree/main/packages/dashboard)
